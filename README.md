# Темплейт с готовым Тротлингом и подключение к PostgreSQL с помощью библиотеки asyncpg.
...
* [asyncpg](https://magicstack.github.io/asyncpg/current/) - взаимодействие с базой данных PostgreSQL
